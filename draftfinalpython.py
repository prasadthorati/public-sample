...
<div class="page">
    ...
    <div class="box">
        ...
        <form method="post" action="/send">
            ...
            <div id="message_editor" contenteditable="true">Hi @Everyone,<br><br>Please proceed with pre-piv, attach artefacts to CTASK and move to &ldquo;In progress&rdquo; once done.<br>- CHG0690343 &ndash; Sat 04 July</div>
            <textarea id="message_html_hidden" name="message_html" style="display:none;"></textarea>

            <div class="checkbox-row"><input type="checkbox" name="everyone" checked> Convert @Everyone to actual Teams mention</div>
            <div class="checkbox-row"><input type="checkbox" name="mention_poc"> Mention POC from Excel</div>
            <div class="checkbox-row"><input type="checkbox" name="include_table" checked> Include App / CTASK table below message</div>
